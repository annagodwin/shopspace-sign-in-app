...
members_name_set = load_members_name_set(Path('resources/sign_in_app/open_time_safety_class_list.csv'))
members_details_df = lookup_member_details_df(Path('resources/sign_in_app/open_time_safety_class_list.csv'))
